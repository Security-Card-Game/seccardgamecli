...
impl LabelWithInputComponent {
    ...
    pub(crate) fn draw_component<T>(&mut self, default: T, ui: &mut Ui, options: LabelWithInputLayoutOptions)
    where
        T: std::str::FromStr + ToString,
    {
        ...
        ui.vertical(|ui| {
            ...
            ui.allocate_ui_with_layout(
                ...
                let label_width = (ui.available_width() - options.input_width - ui.spacing().item_spacing.x).max(0.0);
                ...
                ui.allocate_ui_with_layout(
                    ...
                    |ui| {
                        let input =
                            ui.add(egui::TextEdit::singleline(&mut self.value).desired_width(options.input_width));
